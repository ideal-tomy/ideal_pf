...
export const catalogCopy = {
 ...
 'product-flow-mfg':['製造の判断を支える','現場判断・手順改定を画面で考える。',1,'32%'],
 'approval-inspection':['受入検査の照合と承認','照合の結果と、確認する根拠をつなぐ。',1,'44%'],
 'inspection-record':['設備の点検を記録する','点検項目の入力から、記録の確認へ。'],
 'cause-demo':['原因分析を順に見る','記録を同じ時間軸に揃える考え方。',1,'32%'],
 'kaigo-handoff':['申し送り・面談・日報','日々のメモを整理して、記録を確認。',2,'28%'],
 'childcare':['保育の記録と連絡','園の出来事を、報告と確認につなぐ。',1,'26%'],
 'voice-karte-simple':['短い申し送りを試す','記録がまとまる流れを、短いデモで。',0,'34%'],
 'pharmacy-transfer':['薬局間で在庫を融通','在庫の依頼から受渡しまでを紹介。'],
 'kaigo-3role':['介護を3つの役割で見る','現場・内勤・医療の画面を見比べる。',0,'58%'],
 'disaster-facility':['防災施設の状態を見る','施設の情報と判断の根拠を確認。',1,'28%'],
 'gym-facility':['体育館の施設管理','状態と点検の記録から判断を考える。',1,'28%'],
 'chiiki-bunka':['地域の語りを旅の案内へ','文化の記録から提案へつなぐ流れ。',0,'18%'],
 'shift':['希望からシフト案へ','希望の提出、割当案、欠勤対応を確認。',1,'34%'],
 'shikomi-record':['仕込みの記録と知見','日々の気づきを、次の仕事に残す。',1,'32%'],
 'haken-dash':['派遣営業の状況を見る','候補・案件・収益の情報を見渡す。',1,'28%'],
 'sfa-legal':['相談案件を次の対応へ','相談から受任判断までの流れを見る。',1,'40%'],
 'vietnam-haken':['人材紹介の選考を進める','応募者と企業、選考の進捗を確認。',1,'32%'],
 'property-match':['条件から物件を比べる','物件の順位と提案理由を紹介。'],
 'customer-support':['業種別の案内チャット','問い合わせへの案内と根拠を確認。',2,'24%'],
 'internal-knowledge':['規程・マニュアルに聞く','社内の用件から、結論と根拠へ。',0,'14%'],
