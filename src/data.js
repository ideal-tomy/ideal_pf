...
export const DEMOS = [
  ...
  },
  {
    ...
    url:'',
    linkState:'preparing',
    experienceNote:'公開URLを準備しています。説明デモとしての掲載です。',
    when:'原因分析の手順を社内で共有しづらい製造現場を想定しています。',
    can:['原因特定のストーリー画面を確認できます'],
    planned:['入口整備とモバイル確認'],
  ...
  },
  {
    ...
    url:'',
    linkState:'preparing',
    experienceNote:'公開URLを準備しています。固定データの表示があります。',
    when:'段取りが個人の経験に依存し、変更のたびに手戻りが大きい現場を想定しています。',
    can:['入力から計画・出力の流れを想定できます','変更時の再計算の画面構成を確認できます'],
    planned:['完走確認と公開'],
  ...
  },
  {
    ...
    one:'地域文化の提案デモです。代表シナリオを整理中です。',
    audience:'自治体と地域事業者',
    url:'',
    linkState:'preparing',
    experienceNote:'代表シナリオと入口を整理しています。実在地域と架空提案を区別します。',
    when:'地域の魅力が資料に散らばり、来訪者への提案が属人化している場面を想定しています。',
    can:['地域シナリオの画面構成を確認できます'],
    planned:['代表シナリオ1本と入口の確定'],
